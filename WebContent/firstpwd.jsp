...
<body>
	<div class="container-fluid">
		...
		<s:form action="pwdchange" method="post">
			<s:textfield name="userid" cssClass="form-group form-control"
				type="text" label="Enter Your UserId" />
			<s:textfield name="contact" cssClass="form-group form-control"
				type="text" label="Enter Your Contact" />
			<s:textfield name="email" cssClass="form-group form-control"
