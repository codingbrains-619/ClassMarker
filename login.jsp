			...
			<div class="container">
				...
				<div class="signin-content">
					...
					<div class="signin-form">
						...
						<button type="button" onclick="showregister()" class="btn btn-primary mt-3">New User! Create An Account!!!!</button>
			<div id="register-box" class="hide">
				<form action="showbranchsemestersubject" namespace="/">
					<button class="btn btn-primary mt-2 ml-3 float-left">Teacher</button>
				</form>
				<form action="showbranchsemester" namespace="/">
					<button class="btn btn-primary mr-5 mt-2 float-right">Student</button>
				</form>
			</div>
					</div>
