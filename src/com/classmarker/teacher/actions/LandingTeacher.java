...
public class LandingTeacher {
	...
	public String fetch() throws ClassNotFoundException, SQLException, NamingException {
		...
		pstmt = con.prepareStatement("select test_mst.testname,test_mst.marksperquestion,branch_mst.branchname,group_mst.groupname,semester_mst.semestername, subject_mst.subjectname, user_mst.userid from test_mst,branch_mst,group_mst,subject_mst,semester_mst,userteacher_branch_semester_subject_mapping,test_branch_semester_subject_group_mapping,user_mst where test_branch_semester_subject_group_mapping.testid=test_mst.testid and user_mst.uid=userteacher_branch_semester_subject_mapping.userid and test_branch_semester_subject_group_mapping.branchid=branch_mst.branchid and test_branch_semester_subject_group_mapping.semesterid=semester_mst.semid and test_branch_semester_subject_group_mapping.subjectid=subject_mst.sid and test_branch_semester_subject_group_mapping.groupid=group_mst.groupid and  test_branch_semester_subject_group_mapping.subjectid=userteacher_branch_semester_subject_mapping.subjectid and userteacher_branch_semester_subject_mapping.userid=?");
