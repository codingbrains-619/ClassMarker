...
public class LandingAdmin {
	...
	public String toString() {
		return "LandingAdmin [usercount=" + usercount + ", teachercount=" + teachercount + ", studentcount="
				+ studentcount + ", testcount=" + testcount + ", groupcount=" + groupcount + ", branchcount="
				+ branchcount + ", rolecount=" + rolecount + ", subjectcount=" + subjectcount + ", semestercount="
	...
	public String fetch() throws ClassNotFoundException, SQLException, NamingException {
		...
		pstmt8 = con.prepareStatement("select count(*) from user_mst,user_role_mapping, role_mst where user_role_mapping.userid=user_mst.uid and user_role_mapping.roleid=role_mst.roleid and role_mst.rolename=\"teacher\"");
		rs8 = pstmt8.executeQuery();
		pstmt9 = con.prepareStatement("select count(*) from user_mst,user_role_mapping, role_mst where user_role_mapping.userid=user_mst.uid and user_role_mapping.roleid=role_mst.roleid and role_mst.rolename=\"student\"");
