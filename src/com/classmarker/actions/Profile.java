...
import com.classmarker.admin.actions.Role;
...
public class Profile {
	...
	public String toString() {
		return "Profile [userenrollment=" + userenrollment + ", userid=" + userid + ", contact=" + contact + ", email="
	...
	public String fetchprofile() throws ClassNotFoundException, SQLException {
		...
		pstmt = con.prepareStatement("select userenrollment,userid,contact,email,password from user_mst where status=\"Y\"");
